/****************************************************************************
 * contest2026_094_andy/chip/d13x/d13x_i2c.c
 *
 * SPDX-License-Identifier: Apache-2.0
 *
 * Polled DesignWare I2C master driver for D13x. The transfer model follows
 * the hardware-proven lladlam D13x port and deliberately avoids IRQ-driven
 * wakeups while the E907 CLIC context path is still under validation.
 ****************************************************************************/
...
{
  uintptr_t cmu_reg = CMU_BASE + D13X_I2C_CMU_BASE_OFFSET +
